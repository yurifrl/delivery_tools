...
class CorreiosTracker
  ...
  #delivered
  #failed
  COMMUM_STATES = [2,3,4,5,6,7,8,9,10,12,19,20,21,22,23,24,25,26,28,32,33,34,35,36,37,38,40,41,42,43,45,46,47,48,49,50,51,52,53,55,56,57,58,59,69]
  TIPOS = {
      ...
      4 => {'BDE' => COMMUM_STATES, 'BDI' => COMMUM_STATES, 'BDR' => COMMUM_STATES, 'BLQ' => [1], 'CAR' => [], 'CD' => [], 'CMT' => [], 'CO' => [], 'CUN' => [], 'DO' => [], 'EST' => [], 'FC' => [1,4,5,7], 'IDC' => [1,2,3,4,5,6,7,8,9], 'LDI' => [1,2,3,14], 'LDE' => [], 'OEC' => [], 'PAR' => [], 'PMT' => [], 'PO' => [], 'RO' => [], 'TRI' => []}
  }
